...
class TestRegressionGate(unittest.TestCase):
    def test_regression_gate_states(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(report_pass["metrics"]["correctness"]["status"], "PASS")
            ...
            self.assertEqual(report_fail["metrics"]["correctness"]["status"], "FAIL")
            ...
            self.assertEqual(report_warn["status"], "WARN")
            self.assertEqual(report_warn["metrics"]["latency"]["status"], "WARN")
